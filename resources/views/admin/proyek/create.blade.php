    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Proyek Baru</h1>
                    <p class="text-gray-600">Isi informasi proyek penelitian atau pengembangan</p>
                </div>
            ...
            <form action="{{ route('proyek.store') }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <textarea id="description" 
                              ...
                              placeholder="Masukkan deskripsi proyek">{{ old('description') }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
