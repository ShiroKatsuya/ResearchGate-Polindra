    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Perangkat Lunak Baru</h1>
                    <p class="text-gray-600">Isi informasi perangkat lunak mahasiswa</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <form action="{{ route('perangkatlunak.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <!-- Removed unrelated status and date fields for perangkat lunak -->
