    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Mahasiswa</h1>
            ...
            <form action="{{ route('student.update', $student->id) }}" method="POST" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text"
                           id="program_study"
                           name="program_study"
                           value="{{ old('program_study', $student->program_study) }}"
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('year_of_graduation', $student->year_of_graduation) }}"
