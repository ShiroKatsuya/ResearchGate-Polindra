    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Perkenalan</h1>
                    <p class="text-gray-600">Perbarui informasi data perkenalan</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <form action="{{ route('perkenalan.update', $perkenalan->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" 
                           id="name" 
                           name="name" 
                           value="{{ old('name', $perkenalan->name) }}"
                ...
                <div>
                    ...
                    <input type="text"
                           id="program_study"
                           name="program_study"
                           value="{{ old('program_study', $perkenalan->program_study) }}"
                ...
                <div>
                    ...
                    <input type="number"
                           ...
                           value="{{ old('year_of_graduation', $perkenalan->year_of_graduation) }}"
                ...
                <div>
                    ...
                    <input type="email"
                           id="email"
                           name="email"
                           value="{{ old('email', $perkenalan->email) }}"
                ...
                <div>
                    ...
                    <input type="text"
                           id="phone"
                           name="phone"
                           value="{{ old('phone', $perkenalan->phone) }}"
