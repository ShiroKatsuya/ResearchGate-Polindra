    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Tambah Publikasi Baru</h1>
                    <p class="text-gray-600">Isi informasi publikasi penelitian atau karya ilmiah</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <form action="{{ route('publikasi.store') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <textarea id="abstract" 
                              ...
                              placeholder="Masukkan abstrak publikasi">{{ old('abstract') }}</textarea>
                    @error('abstract')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
