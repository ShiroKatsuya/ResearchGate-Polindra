    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    <h1 class="text-3xl font-bold text-gray-900 mb-2">Edit Publikasi</h1>
                    <p class="text-gray-600">Perbarui informasi publikasi penelitian atau karya ilmiah</p>
                </div>
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
            <form action="{{ route('publikasi.update', $publikasi->id) }}" method="POST" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div>
                    ...
                    <input type="text" 
                           id="title" 
                           name="title" 
                           value="{{ old('title', $publikasi->title) }}"
                ...
                <div>
                    ...
                    <input type="text" 
                           id="journal" 
                           name="journal" 
                           value="{{ old('journal', $publikasi->journal) }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('journal') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <textarea id="abstract" 
                              name="abstract" 
                              rows="4"
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('abstract') border-red-500 @enderror"
                              placeholder="Masukkan abstrak publikasi">{{ old('abstract', $publikasi->abstract) }}</textarea>
                    @error('abstract')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('doi') border-red-500 @enderror"
                           placeholder="Contoh: 10.1000/182">
                    @error('doi')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input type="url" 
                           ...
                           class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 @error('url') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <input type="hidden" id="student_id" name="student_id" value="{{ old('student_id', $publikasi->student_id) }}">
                ...
                <div>
                    ...
                    <input type="date" 
                           id="published_at" 
                           name="published_at" 
                           value="{{ old('published_at', $publikasi->published_at ? $publikasi->published_at->format('Y-m-d') : '') }}"
